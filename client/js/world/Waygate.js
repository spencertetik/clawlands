...
class Waygate {
    constructor(x, y, name = 'Ancient Waygate') {
        ...
        // Restored to proper values - need 70% to see, 90% to use
        this.visibilityThreshold = 70;      // Start seeing at 70%
        this.fullVisibilityThreshold = 90;  // Fully visible/usable at 90%
